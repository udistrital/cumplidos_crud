...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/udistrital/cumplidos_crud/controllers:FechasCargaCumplidosController"] = append(beego.GlobalControllerRouter["github.com/udistrital/cumplidos_crud/controllers:FechasCargaCumplidosController"],
        beego.ControllerComments{
            Method: "Post",
            Router: "/",
            AllowHTTPMethods: []string{"post"},
